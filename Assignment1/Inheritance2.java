//Problem Statement for the Java Inheritance2
...
42 13 20
*/
//Solution : We need to implement Arithmetic class and a method called add in it.
//Another class Adder which extends Arithmetic 
import java.io.*;
import java.util.*;
import java.text.*;
import java.math.*;
...
class Arithmetic{
    // add method returs the sum of 2 numbers 
    int add(int a,int b){
        return a+b;
    }
}
class Adder extends Arithmetic{
    //This class only contains a default constructor 
}
