//problem statement:try with multiple catch blocks
/*
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        try {
            int x=sc.nextInt();
            int y=sc.nextInt();
            System.out.println(x/y);//from the statement we are performing the division
        }
        //catching input mismatch exception in the first catch bolck
