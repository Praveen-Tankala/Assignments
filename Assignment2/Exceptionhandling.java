//problem statement: Exception Handling in java
/*
...
class MyCalculator {
    ...
    */
    //the method should indicate that it throws exception
    public long power(int a,int b) throws Exception{
        //if both are zero the throw the exception should not be zero ...
        if(a==0 && b==0)
            throw new Exception("n and p should not be zero.");
        //if anyone of the values is negative then throw the exception should not be negative
        else if(a<0 || b<0)
